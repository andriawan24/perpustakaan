...
@section('title', "Tambah Buku | Perpustakaan SMK Negeri 2 bandung")
...
<section>
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="title-1 m-b-35 mt-4">Tambah Buku</h3>
                        ...
                        <div class="card-body card-block">
                            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="penulis" id="penulis" class="form-control" value="{{ old("penulis") }}" placeholder="Masukkan Nama Penulis">
                                        @error("penulis")
                                            <span class="help-block invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="penerbit" id="penerbit" class="form-control" value="{{ old("penerbit") }}" placeholder="Masukkan Nama Penerbit">
                                        @error("penerbit")
                                            <span class="help-block invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" name="jumlah" id="jumlah" class="form-control" value="{{ old("jumlah") }}" placeholder="Masukkan Stok Buku">
                                        @error("jumlah")
                                            <span class="help-block invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
